...
<head>
    ...
    <meta name="keywords" content="Atheeq, portfolio, Atheeq, full stack dev, personal portfolio lifecodes, portfolio design, portfolio website, personal portfolio" />
    <meta name="description" content="Welcome to Atheeq's Portfolio. Full-Stack Web Developer and Android App Developer" />
    <!-- Custom CSS -->
    ...
    <div align="center" class="content" >
        ...
        <div class="socials">
            <ul class="social-icons">
                <li><a class="linkedin" aria-label="LinkedIn" href="" target="_blank"><i class="fab fa-linkedin"></i></a></li>
